...
work=$(mktemp -d)
compose="docker-compose --project-name $project --env-file $root/deploy/integration.env -f $root/deploy/docker-compose.yml -f $root/deploy/docker-compose.integration.yml"
