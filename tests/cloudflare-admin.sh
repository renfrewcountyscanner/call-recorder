...
CALL_RECORDER_ADMIN_ENABLED=true CALL_RECORDER_ADMIN_TOKEN= CALL_RECORDER_CLOUDFLARE_ACCESS_ENABLED=true CALL_RECORDER_CLOUDFLARE_ADMIN_EMAIL=renfrewcountyscanner@gmail.com $compose up -d --no-deps --force-recreate backend >/dev/null
